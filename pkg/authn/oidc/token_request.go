...
type AccessTokenRequest struct {
	...
	Scopes              SpaceDelimitedArray `schema:"scope,omitempty"`
}

func (a *AccessTokenRequest) GetClientID() string {
	return a.ClientID
}

func (a *AccessTokenRequest) GetClientSecret() string {
...
func (a *RefreshTokenRequest) GetClientID() string {
	return a.ClientID
}

func (a *RefreshTokenRequest) GetClientSecret() string {
	return a.ClientSecret
}
...
func (r ClientCredentialsRequest) GetClientID() string {
	return r.ClientID
}

func (r ClientCredentialsRequest) GetClientSecret() string {
	return r.ClientSecret
}
